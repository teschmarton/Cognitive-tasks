# My_tasks
Computer based cognitive tasks/ Számítógépes kognitív tesztek

#english version

In the folder, cognitive psychology tasks are available in the form of computer programs targeting various aspects of human mental representations. The programs solely measure reaction times, and no personal data from the participant is required to perform the tasks. Data storage and usage occur anonymously. After downloading and extracting the compressed folders, you can run the program.exe file. After completing the task, an Excel file named 'adat.xlsx' will appear in the folder containing the reaction times, serving as the basis for data analysis. These task serve demo purposes only and should not be considered as serious research tools.
